...
4034-- In the spring, I empty my pool with a pump that has a four
cubic meter flow rate for an hour so I can fill it with clean water
using the same pump. My pool contains 54 cubic meter of water when
it is full and is two thirds full before being emptied in the
spring. How long will it take to empty the pool and how long will it
take to fill
it up?\\
...
Sincr it contains 54 cubic meters when full and is filled to the two
thirds of its capacity, it contains $\frac{2}{3}$ of $54 = 36 $
cubic meters of water before being emptied. With a $4$ cubic meter
flow rate, the time needed to empty the pool is:\\[2mm]
$\frac{36}{4}=9$\\

The pool is empty after 9 hours of pumping. The time needed to fill it up to its full capacity is :\\[2mm]
$\frac{54}{4}=13,5$\\
