...
\begin{center}
Émile got \underline{\quad\quad}\% on his writing exam.\\
\end{center}
...
the fracion of a year.\\
The answer is d).\\


7325-- Choose the most realistic numver to complete the sentence.\\
\begin{center}
...
\hline
\multicolumn{9}{|c|}{entiers} &\multicolumn{3}{|c|}{d\'ecimaux} \\
\hline
\multicolumn{3}{|c|}{classe des} &\multicolumn{3}{|c|}{classe des} &\multicolumn{3}{|c|}{classe des} &  \multicolumn{3}{c|}{} \\
\multicolumn{3}{|c|}{millions} &\multicolumn{3}{|c|}{mille} &\multicolumn{3}{|c|}{unit\'es} &  \multicolumn{3}{c|}{} \\
\hline
C & D & U & C & D & U &C & D & U, & D\up{e} & C\up{e} & M\up{e} \\
\hline
\hline
&  & 1 & 0 & 0 & 0 & 0 & 0 & 0 &  &  &  \\
 &  &  & 9 & 8 & 3 & 5 & 0 & 2  &  &  & \\
