...
\end{wrapfigure}
La figure de droite peut être obtenue en traçant 6 demi-cercles. Si $AB=BC=CD=DE$, si l'aire de la région ombragée est $x$ et que son périmètre est $y$ et si l'aire et and the area and the circumference of the outside circle are $r$ and $s$, then $\frac{x}{r}+\frac{y}{s}$ equals:\\
%ChoiceA
(A) $\frac{1}{2}$\\
%ChoiceB
(B) 1\\
