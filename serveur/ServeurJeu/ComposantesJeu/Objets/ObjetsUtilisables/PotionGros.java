 ...
 */
public class PotionGros extends ObjetUtilisable 
{
	...
	public static final String TYPE_OBJET = "PotionGros";
	 ...
	 * 							   visible ou non
	 */
	public PotionGros(int id, boolean estVisible)
	{
		// Appeler le constructeur du parent
		super(id, estVisible, UID_OU_POTIONGROS, PRIX, EST_LIMITE, PEUT_ETRE_ARME, TYPE_OBJET);
	}
