 ...
 */
public class PotionPetit extends ObjetUtilisable 
{
	...
	public static final String TYPE_OBJET = "PotionPetit";
	 ...
	 * 							   visible ou non
	 */
	public PotionPetit(int id, boolean estVisible)
	{
		// Appeler le constructeur du parent
		super(id, estVisible, UID_OU_POTIONPETIT, PRIX, EST_LIMITE, PEUT_ETRE_ARME, TYPE_OBJET);
	}
