...
public class QuestionComparator implements Comparator<Map<SmacParser.Tag,String>>
{

  public static int compareIdentifiers(Map<SmacParser.Tag,String> q1, Map<SmacParser.Tag,String> q2)
  {
    String v1 = q1.get(SmacParser.Tag.Source);
    if (v1 != null) //q1 has a Source
    {
      //Compare Tag.Source (this tag is optional)
      String v2 = q2.get(SmacParser.Tag.Source);
      ...
      v1 = q1.get(SmacParser.Tag.Title);
      v2 = q2.get(SmacParser.Tag.Title);
    ...
    else //q1 does not have a Source
    {
      ...
      if (q2.get(SmacParser.Tag.Source) != null) return 1;
      //Compare Tag.Creator (this tag is mandatory)
      v1 = q1.get(SmacParser.Tag.Creator);
      String v2 = q2.get(SmacParser.Tag.Creator);
      int cmp = v1.compareTo(v2);
      if (cmp != 0) return cmp;
    }

    //Next tie breaker: Compare Tag.Question (this tag is mandatory)
    v1 = q1.get(SmacParser.Tag.Question);
    String v2 = q2.get(SmacParser.Tag.Question);
    int cmp = v1.compareTo(v2);
    return cmp; 

  }

  public int compare(Map<SmacParser.Tag,String> q1, Map<SmacParser.Tag,String> q2)
  {
    ...
    String v1 = q1.get(SmacParser.Tag.Language);
    String v2 = q2.get(SmacParser.Tag.Language);
    cmp = v1.compareTo(v2);
    ...
    String t1 = q1.get(SmacParser.Tag.Translator);
    String t2 = q2.get(SmacParser.Tag.Translator);
